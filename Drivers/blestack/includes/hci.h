...
/**
 * This function must be used to pass the byte received from the HCI serial
 * interface to the BLE Stack HCI state machine.
 *
 * @param[in] byte          The byte that is received from HCI interface.
 *
 */
void hci_input(tHalUint8 byte);
